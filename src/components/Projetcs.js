        ...
        <div id='projects' className='flex flex-col py-2 px-5 justify-center items-center h-auto gap-10  bg-gray-100'>
            ...
            <div className={`flex ${screenize.width > 1000 ? 'justify-between' : 'flex-col justify-center items-center'}  mx-12`}>
                <div className={`${screenize.width > 1000 ? 'w-[50%]' : 'w-[100%]'} `}>
                    <div className={`flex justify-center items-center ${screenize.width > 1000 ? 'h-[20rem] w-[25rem]' : 'h-[10rem] w-[15rem]'}  border border-slate-100 rounded-3xl bg-sky-950`}>
                ...
                <div className={`flex flex-col gap-5 ${screenize.width > 1000 ? 'w-[50%]' : 'justify-center items-center mt-[3%]'} `}>
                    ...
                    <button className={`bg-sky-500 py-3 px-2 ${screenize.width > 1000 ? 'h-[3rem] w-[25%]' : 'w-auto'} w-auto rounded text-md font-bold text-white shadow-lg uppercase mt-3 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 hover:bg-sky-400 duration-300`}><a href='#/bank'>see more...</a></button>
                </div>
            </div>

            <div className={`flex ${screenize.width > 1000 ? 'justify-between' : 'flex-col justify-center items-center'}  mx-12`}>
                <div className={`${screenize.width > 1000 ? 'w-[50%]' : 'w-[100%]'} `}>
                    <div className={`flex justify-center items-center ${screenize.width > 1000 ? 'h-[20rem] w-[25rem]' : 'h-[10rem] w-[15rem]'}   border border-slate-100 rounded-3xl bg-stone-800`}>
